...
urlpatterns = [
    ...
    url(r'^password_reset/$', views.password_reset, {'template_name': 'password_reset.html', 'email_template_name': 'emails/password_reset_request.txt', 'html_email_template_name': 'emails/password_reset_request.html'}, name='password_reset'),
    ...
    url(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
        views.password_reset_confirm, {'template_name': 'password_reset_form.html'}, name='password_reset_confirm'),
    url(r'^reset/done/$', views.password_reset_complete, {'template_name': 'password_reset_complete.html'}, name='password_reset_complete'),
