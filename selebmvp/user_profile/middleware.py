...
class EventOwnerMiddleware:
    ...
    See https://docs.djangoproject.com/en/1.9/ref/utils/#django.utils.decorators.decorator_from_middleware and https://docs.djangoproject.com/en/1.9/topics/http/middleware/#writing-your-own-middleware
